...
const SOCIAL_LINKS: {
  ...
  {
    name: 'LinkedIn',
    link: 'https://www.linkedin.com/in/rgorai',
    icon: (
      <svg
  ...
  {
    name: 'NPM',
    link: 'https://www.npmjs.com/~rgorai',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
  ...
  {
    name: 'StackOverflow',
    link: 'https://stackoverflow.com/users/14898247/ron-gorai',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="28"
...
const Footer = (props: Props) => {
  ...
  return (
    <footer className={cx('bg-dark', styles.footerContainer)}>
